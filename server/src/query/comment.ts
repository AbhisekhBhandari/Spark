...
)SELECT ic."commentId", ic."postId", ic."userId", c."username", c."profilePicture" FROM 
	inserted_comment ic
	LEFT JOIN
...
SELECT co."commentId", co."userId", co."postId" ,us."username", us."profilePicture", co."comment"   FROM public."Comments" co LEFT JOIN public."User" us on co."userId" = us."userId";
`;
